...
namespace Gley.PedestrianSystem.Internal
{
    public class WaypointActivator
    {
        ...
        internal WaypointActivator(Area disableWaypointsArea, PedestrianWaypointsDataHandler pedestrianWaypointsDataHandler, GridDataHandler gridDataHandler)
        {
        ...
        {
            List<int> waypoints = _gridDataHandler.GetPedestrianWaypointsInArea(area);
