...
{
    internal class PedestrianPathDrawer : RoadDrawer<PedestrianPathEditorData,PedestrianPath>
    {
        internal PedestrianPathDrawer (PedestrianPathEditorData data):base(data) 
        {

        }


        internal void ToggleClosed(PedestrianPath road)
        {
            Path path = road.path;
        ...
        internal void CloseLoop(PedestrianPath road)
        {
        ...
        internal void AddPathPoint(Vector3 mousePosition, PedestrianPath road, bool clicked)
        {
            if (clicked == true)
            {
                return;
        ...
        protected override Vector3 DrawHandle(Path path, int i, RoadBase road, float handleSize)
        {
