...
{
    internal class PedestrianWaypointDrawer : Drawer
    {
        ...
        internal delegate void WaypointClicked(PedestrianWaypointSettings clickedWaypoint, bool leftClick);
        ...
        internal PedestrianWaypointDrawer (PedestrianWaypointEditorData pedestrianWaypointData):base (pedestrianWaypointData)
        {
        ...
        internal void DrawWaypointsForLink(PedestrianWaypointSettings currentWaypoint, List<WaypointSettingsBase> neighborsList, Color waypointColor)
        {
            _colorChanged = true;
        ...
        internal void ShowAllWaypoints(Color waypointColor, bool showConnections, bool showPedestrians, Color pedestriansColor, bool showPriority, Color priorityColor)
        {
            var allWaypoints = _pedestrianWaypointData.GetAllWaypoints();
            _colorChanged = true;
            UpdateInViewProperty(allWaypoints);
        ...
        internal void ShowWaypointsWithPedestrian(PedestrianTypes pedestrian, Color color)
        {
            var allWaypoints = _pedestrianWaypointData.GetAllWaypoints();
            _colorChanged = true;
            UpdateInViewProperty(allWaypoints);
        ...
        internal void ShowPedestrianTypeEditedWaypoints(Color waypointColor, Color carsColor)
        {
        ...
        internal void ShowEventWaypoints(Color waypointColor, Color labelColor)
        {
        ...
        internal PedestrianWaypointSettings[] ShowVehicleProblems(Color waypointColor, Color carsColor)
        {
            var allWaypoints = _pedestrianWaypointData.GetAllWaypoints();
            _colorChanged = true;
            UpdateInViewProperty(allWaypoints);
        ...
        internal void DrawSelectedWaypoint(PedestrianWaypointSettings selectedWaypoint, Color color)
        {
            _colorChanged = true;
        ...
        internal void DrawDirectionWaypoint(WaypointSettingsBase stopWaypoint, Color stopWaypointsColor)
        {
        ...
        internal void DrawAllPathConnectors(Color connectorLaneColor, bool showConnections, Color connectionColor, bool showCars, Color carsColor)
        {
            var allWaypoints = _pedestrianWaypointData.GetAllWaypoints();
            for (int i = 0; i < allWaypoints.Length; i++)
            {
        ...
        internal void DrawPossibleDirectionWaypoints(List<PedestrianWaypointSettings> waypoints, Color waypointColor)
        {
            _colorChanged = true;
        ...
        internal void UpdateInViewProperty(PedestrianWaypointSettings[] selectedWaypoints)
        {
